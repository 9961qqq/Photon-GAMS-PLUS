...
CloudsResult draw_altocumulus_clouds(
	...
	float extinction_coeff = mix(0.08, 0.16, day_factor) * CLOUDS_ALTOCUMULUS_DENSITY * (1.0 - 0.85 * high_coverage * (dampen(time_noon + time_midnight) * 0.75 + 0.25)) * (1.0 - 0.33 * rainStrength);
